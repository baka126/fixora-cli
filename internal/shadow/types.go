...
type Result struct {
	...
	// Caveats lists non-blocked production surfaces a PASS did not actually
	// exercise. It lowers stated confidence only; it never feeds the apply gate
	// (fix.Plan.ApplyEligible).
